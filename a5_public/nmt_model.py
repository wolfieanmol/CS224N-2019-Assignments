...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        X = self.model_embeddings_source(source_padded)  # (s, b, e)
        ...
        last_hidden = torch.cat((last_hidden[0], last_hidden[1]),
                                1)  # (2, b, h) -> (b, 2h) 2 is forthe two hidden states of forward and backward rnn
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        Y = self.model_embeddings_target(target_padded)  # (t, b, e)
